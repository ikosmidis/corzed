...
c_num <- corzed(modML, numeric = FALSE, parallel = TRUE)
c_ana <- corzed(modML, numeric = TRUE, parallel = TRUE)
...
c1_num <- corzed(modML1, numeric = FALSE, parallel = TRUE)
c1_ana <- corzed(modML1, numeric = TRUE, parallel = TRUE)

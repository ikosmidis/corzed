...
c_num <- waldi(modML, numeric = FALSE, parallel = TRUE)
c_ana <- waldi(modML, numeric = TRUE, parallel = TRUE)
...
c1_num <- waldi(modML1, numeric = FALSE, parallel = TRUE)
c1_ana <- waldi(modML1, numeric = TRUE, parallel = TRUE)

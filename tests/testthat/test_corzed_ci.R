...
ci95_corzed1 <- corzed_confint(babies_ml1, level = 0.95, adjust = TRUE, which = c(16, 18, 20))
ci95_corzed2 <- corzed_confint(babies_ml1, level = 0.95, adjust = TRUE, which = names(coef(babies_ml1))[c(16, 18, 20)])
